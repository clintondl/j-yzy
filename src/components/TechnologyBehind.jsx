  ...
  return (
    <section className="py-16 relative">
      <div className="container">
        ...
        <div className="mt-[87px] lg:mt-[106px] lg:h-[470px] bg-[url(/image.png)] lg:bg-[url(/circular-bg.png)] bg-no-repeat bg-center bg-contain lg:bg-cover lg:max-w-[978px] bg-clip-content bg-origin-content mx-auto ">
